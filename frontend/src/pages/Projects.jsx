...
import { Plus, Search, Users, Code2, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <button className="flex items-center gap-2 rounded-xl bg-cyan-400 px-6 py-3 font-semibold text-black hover:bg-cyan-300">
